...
function autocomplete(input, latInput, lngInput) {
  ...
  // adds an event listener to the dropdown and gets the lat/log for location
...
var mapOptions = {
  center: { lat: 36.17, lng: -115.15 },
  zoom: 10
};

// Vegas: lat = 36.17 lng = -115.15

function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 36.17;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -115.15;

  _axios2.default.get('/api/parks/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    var places = res.data;
    if (!places.length) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener('click', function () {
        ...
        var html = '\n          <div class="popup">\n            <a href="/park/' + this.place.slug + '">\n              <img src="/uploads/' + (this.place.photo || 'park.jpg') + '" alt="' + this.place.name + '" />\n              <p>' + this.place.name + ' - ' + this.place.location.address + '</p>\n            </a>\n          </div>\n        ';
...
function searchResultsHTML(parks) {
  return parks.map(function (park) {
    return '\n      <a href="/park/' + park.slug + '" class="search__result">\n        <strong>' + park.name + '</strong>\n      </a>\n    ';
  }).join('');
}
